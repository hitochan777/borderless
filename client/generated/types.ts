...
export type TweetFieldFragmentFragment = (
  { __typename?: 'Tweet' }
  & Pick<Tweet, 'id' | 'text'>
);

export type PostFieldFragmentFragment = (
  { __typename?: 'Post' }
  & Pick<Post, 'id' | 'title' | 'json' | 'isDraft'>
  & { lines: Array<(
    { __typename?: 'Line' }
    & Pick<Line, 'id'>
    & { partialLines: Array<(
      { __typename?: 'PartialLine' }
      & Pick<PartialLine, 'text'>
    )>, replies: Array<(
      { __typename?: 'Tweet' }
      & TweetFieldFragmentFragment
    )> }
  )>, language: (
    { __typename?: 'Language' }
...
export type FetchViewerQuery = (
  ...
  & { viewer: (
    { __typename?: 'User' }
    & Pick<User, 'id' | 'username' | 'email' | 'fluentLanguages' | 'learningLanguages'>
    & { posts: Array<(
      { __typename?: 'Post' }
      & PostFieldFragmentFragment
    )> }
  ) }
);
...
export type FetchFeedForUserQuery = (
  { __typename?: 'Query' }
  & { feed: Array<(
    { __typename?: 'Post' }
    & PostFieldFragmentFragment
...
export type FetchLanguagesQuery = (
  { __typename?: 'Query' }
  & { langs: Array<(
    { __typename?: 'Language' }
    & Pick<Language, 'id' | 'name'>
...
export type UserUpdateMutation = (
  ...
  & { userUpdate: (
    { __typename?: 'User' }
    & Pick<User, 'id' | 'email' | 'username' | 'fluentLanguages' | 'learningLanguages'>
  ) }
);
